...
<div class="wrap">
    ...
    <table id="form-table-connected" class="form-table" style="display: <?= $key && $udimi_prime_features ? '' : 'none' ?>">
        <tr>
            <td>
                Under development. Will be available soon. Meanwhile please use the web version at <a href="https://solocalendar.com" target="_blank">https://solocalendar.com</a>
            </td>
        </tr>
    </table>
</div>
